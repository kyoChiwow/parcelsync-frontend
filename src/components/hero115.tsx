      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-5">
          <div className="relative isolate flex flex-col gap-5">
            ...
            <h1 className="mx-auto max-w-xl lg:max-w-3xl text-center text-4xl font-semibold tracking-tight text-pretty md:text-5xl lg:text-6xl">
              {heading}
            </h1>
            ...
            <div className="flex flex-col items-center gap-3 pt-3 pb-12">
              ...
              {byline && (
                <div className="text-center text-sm text-muted-foreground">{byline}</div>
              )}
            </div>
          </div>
          {image.srcDark ? (
